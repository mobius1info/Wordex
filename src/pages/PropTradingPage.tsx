...
const translations = {
  ru: {
    ...
    rules: {
      ...
      items: [
        'Максимальный дневной убыток: обычно 5% от счета',
        'Максимальный общий убыток: обычно 10% от начального капитала',
        'Цель прибыли: 8-10% для прохождения оценки',
        'Минимальные торговые дни: обычно 4-5 дней',
        'Запрещена торговля новостями в некоторых компаниях'
      ]
    },
    costs: {
    ...
    tips: {
      ...
      items: [
        ...
        'Не торопитесь — у вас обычно нет временных ограничений',
